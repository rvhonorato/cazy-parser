        ...
        for family in family_list:
            ...
            for main_link in superfamily_list:
                ...
                if bool(page_index_list):
                    first_page_idx = int(
                        page_index_list[0]['href'].split('PRINC=')[-1].split('#')[0])  # be careful with this
                    last_page_idx = int(
                        page_index_list[-2]['href'].split('PRINC=')[-1].split('#')[0])  # be careful with this
                    ...
                    for i in range(first_page_idx, last_page_idx + first_page_idx, first_page_idx):
                        link = 'http://www.cazy.org/' + page_index_list[0]['href'].split('=')[0] + '=' + str(i) + '#' + \
                               page_index_list[0]['href'].split('#')[1]
